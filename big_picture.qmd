...
Two interactive maps allow you to explore the connection between racial makeup and fatal police shootings across states:

1. **Map 1: Proportion of People of Color** – Shows the percentage of people of color in each state.
2. **Map 2: Fatal Police Shootings** – Displays fatal shootings per 100,000 residents, adjusting for population size to offer a clearer comparison.
